...
export default class Courses extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            {
                id: 5,
                title: "زبان بزرگسالان", price: "American English file", img: '/images/image-courses/boz.jpg', description: `اگر می‌خواهید زبان انگلیسی را فراتر از مکالمات روزمره یاد بگیرید یا قصد ادامه تحصیل یا کار در محیطی انگلیسی زبان را دارید، این سطح  ۶ ترمی مناسب شماست. در این سطح از دوره آموزش زبان انگلیسی برای بزرگسالان در سفیر، مهارتتان در مکالمه به حدی می‌رسد که به سادگی با افراد بومی (native) صحبت می‌کنید و به درجه‌ای می‌رسید که توانایی درک متن‌های پیچیده کاری و تخصصی را دارید.`
            },
        ...
        return (
            <div className='pruoducts-body'>
                ...
                <header>
                    ...
                    <h1 class="band-name-large ">فهرست دوره های آکادمی</h1>
                </header>
