                                ...
                                <li class=" parentnav ">
                                    ...
                                    <ul class="inside-nav">
                                        ...
                                        <Link className=' secondy' to={`/e/${3}`}>
                                            ...
                                            <Link className=' secondy' to={`/e/${1}`}>Tofel
...
<img src="../images/image-courses/tofel1.png" className='link-image'>
                                        ...
                                        <Link className=' secondy' to={`/e/${2}`}>TTC <img src="../images/image-courses/ttc.jpeg" className='link-image'>
